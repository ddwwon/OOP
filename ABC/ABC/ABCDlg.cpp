...
// CABCDlg: 생성자 함수 실행
CABCDlg::CABCDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_ABC_DIALOG, pParent) // 상속자
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME); // IDR_MAINFRAME: 아이콘
}
...
BOOL CABCDlg::OnInitDialog()
{
	...
	// 어떤 초기 값을 추가하고 싶을 떄, 코드를 추가

	return TRUE;  // 포커스를 컨트롤에 설정하지 않으면 TRUE를 반환합니다.
}

// 실행될때 왼쪽 위에 있는 아이콘에서 어떤 메뉴를 선택할때
